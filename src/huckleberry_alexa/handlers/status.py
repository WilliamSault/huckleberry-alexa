"""Status handlers: LastFeedStatusIntent, LastNappyStatusIntent."""
...
async def _get_last_feed_timestamp(api, child_uid: str) -> int | None:
    """Return the Unix timestamp (seconds) of the most recent feed, or None."""
    now = datetime.now(timezone.utc)
